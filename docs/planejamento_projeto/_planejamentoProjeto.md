...
- **0** – Sem importância
- **1** – Cosmético
- **2** – Simples (baixa prioridade)
- **3** – Grave (alta prioridade)
- **4** – Catastrófico (deve ser corrigido antes da disponibilização)

## 5. Necessidades para a avaliação (Identify)

Para a realização da avaliação heurística são necessários:
...
> [1] BARBOSA, S. D. J.; SILVA, B. S. da; SILVEIRA, M. S.; GASPARINI, I.;
> DARIN, T.; BARBOSA, G. D. J. **Interação Humano-Computador e Experiência
> do Usuário**. 1. ed. Autopublicação, 2021. Capítulo 11 – Planejamento da
> Avaliação de IHC, p. 273–280; Capítulo 12 – Métodos de Avaliação de IHC,
> p. 281–285.

> [2] NIELSEN, Jakob. **Heuristic evaluation**. In: NIELSEN, J.; MACK, R. L.
> (eds.). Usability inspection methods. New York: John Wiley & Sons, 1994.
> *(apud BARBOSA et al., 2021, p. 281)*

> [3] SHARP, H.; ROGERS, Y.; PREECE, J. **Interaction Design: Beyond
...
|------|--------|-----------|-----------|-----------------|-------------|
| 11/04/2026 | `1.0` | Criação do plano de avaliação | Luís Gustavo Lopes Oliveira | — | — |
